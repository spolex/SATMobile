...
/**
 * Clase extraída de http://androideity.com/2013/12/16/android-navigation-drawer-parte-1/
 */
...
public class NavigationAdapter extends BaseAdapter {
	...
	ArrayList<Item_nav> arrayitms;

   public NavigationAdapter(Activity activity,ArrayList<Item_nav>  listarray) {
       super();  
   ...
   public View getView(int position, View convertView, ViewGroup parent) {  
      ...
      if(convertView==null)  
       {  
           ...
           Item_nav itm=arrayitms.get(position);
